defmodule ElixirExif.Tag do
  ...
  defp decode_value(10, component_count, read_unsigned, value), do: decode_ratio(value, component_count, read_unsigned, :signed) # srational
  ...
  defp get_tag_name(_ifd, _tag), do: :unknown
end
